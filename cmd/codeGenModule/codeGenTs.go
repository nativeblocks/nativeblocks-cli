...
func generateTSClass(blockName string, component Integration, kind string) string {
	...
	if kind == "BLOCK" {
		...
		sb.WriteString("  public getAction(event: string): IAction | undefined {\n")
		...
		sb.WriteString("  public getBlock(key: string): any {\n")
		sb.WriteString("    return this.blocks.find((b) => b.key === key);\n")
		sb.WriteString("  }\n\n")

		sb.WriteString("  public getBlocks(): any[] {\n")
	...
	sb.WriteString("  public assignData(key: string, value: any): this {\n")
